...
export class Activator {
    ...
    resolveActivity(activation) {
        ...
        if (activation.result.completed) {
            ...
            reject(new Error(nullToUndefined((_a = activation.result.failed.failure) === null || _a === void 0 ? void 0 : _a.message)));
        }
 ...
 */
export function activate(encodedActivation, jobIndex) {
...
export function concludeActivation(taskToken) {
...
export function propagateCancellation(method) {
    return (reject, scope) => {
        return (err) => {
...
export function childScope(makeRequestCancellation, makeCompleteCancellation, fn) {

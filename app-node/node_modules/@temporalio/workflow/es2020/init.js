import { state, currentScope, Activator } from './internals';
import { msToTs } from './time';
import { alea } from './alea';
import { DeterminismViolationError } from './errors';
export function overrideGlobals(randomnessSeed) {
...
export function initWorkflow(workflowId, randomnessSeed, taskQueue, activityDefaults, runtime) {

...
export function sleep(ms) {
    ...
    return childScope(cancellation, cancellation, () => new Promise((resolve, reject) => {
 ...
 * @hidden
 */
export function scheduleActivity(activityType, args, options) {
    validateActivityOptions(options);
    const seq = state.nextSeq++;
    return childScope(() => (_err) => {
        state.commands.push({
...
export class ContextImpl {
     ...
     * ```
     */
    configure(activity, options = state.activityDefaults) {
 ...
 */
export function cancellationScope(fn) {
 ...
 * @see {@link https://docs.temporal.io/docs/node/workflow-scopes-and-cancellation | Workflow scopes and cancellation}
 */
export function shield(fn, throwOnCancellation = true) {
 ...
 * @see {@link https://docs.temporal.io/docs/node/workflow-scopes-and-cancellation | Workflow scopes and cancellation}
 */
export function cancel(promise, reason = 'Cancelled') {
